...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.grid = RandomizedSearchCV(estimator=self.clf, param_distributions=self.param_grid,n_jobs=-1 ,cv=9, n_iter=40)
    ...
    def get_best_params_for_KNN(self, train_x, train_y):
        ...
        try:
            ...
            # Creating an object of the Grid Search class
            self.grid =  RandomizedSearchCV(estimator=self.knn, param_distributions=self.param_grid_knn,n_jobs=-1 ,cv=9, n_iter=40)
            # finding the best parameters
            self.grid.fit(train_x, train_y)
